...
public class TBody extends GenericTable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8266984734297296375L;

	@Override
	public String build() {
		StringBuilder builder = new StringBuilder();
		builder.append("<").append(TableTag.TBODY_TAG + " ");
		...
		builder.append("</").append(TableTag.TBODY_TAG).append(">");
