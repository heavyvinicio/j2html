...
public class Table extends GenericTable {

	private static final long serialVersionUID = 342351922312225654L;

	@Override
	public String build() {
		StringBuilder builder = new StringBuilder();
		builder.append("<").append(TableTag.TABLE_TAG + " ");
		...
		builder.append("</").append(TableTag.TABLE_TAG).append(">");
