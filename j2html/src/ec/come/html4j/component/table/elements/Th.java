...
public class Th extends Td {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7318840985477261196L;

	@Override
	public String build() {
		StringBuilder builder = new StringBuilder();
		builder.append("<").append(TableTag.TH_TAG + " ");
		...
		builder.append(">").append(value).append("</").append(TableTag.TH_TAG).append(">");
