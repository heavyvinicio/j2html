...
public class THead extends GenericTable {

	private static final long serialVersionUID = -5648713133953712843L;

	@Override
	public String build() {
		StringBuilder builder = new StringBuilder();
		builder.append("<").append(TableTag.THEAD_TAG + " ");
		...
		builder.append("</").append(TableTag.THEAD_TAG).append(">");
